                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-primary">
                      <form id="delete-form-{{ $about->id }}" action="{{ route('admin.about.destroy',$about->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                      </form>
                      ...
                      <a href="{{ route('admin.about.edit',$about->id) }}" class="btn btn-info float-right"> <i class="material-icons">edit</i> </a>
                      <a href="{{ route('admin.about.show',$about->id) }}" class="btn btn-primary float-right"> View </a>
                    </td>
                  </tr>
                  @endforeach
